...
class ssh (
  ...
  $hiera_server_options = lookup("${module_name}::server_options", {merge => hash, default_value => {}})
  $hiera_server_match_block = lookup("${module_name}::server_match_block", {merge => hash, default_value => {}})
  $hiera_client_options = lookup("${module_name}::client_options", {merge => hash, default_value => {}})
  $hiera_users_client_options = lookup("${module_name}::users_client_options", {merge => hash, default_value => {}})
